...
$(function(){
  ...
  var backendHostUrl = 'http://127.0.0.1:8881/api/v1/chat';
  //var backendHostUrl = 'https://backend-dot-xpto.appspot.com.';
    ...
    $.ajax(backendHostUrl + '/messages', {
      ...
      $.each(data, function (key, value) {
        data.results.forEach(function (element, index) {
          var message = element.sender.identifier + " says " +  element.message;
          $('#notes-container').append($('<p>').text(message));
        });
      });
